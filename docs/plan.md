...
valida estructuralmente la carga en el Worker, ofrece la galería reutilizable y
admite bloques de imagen. La sincronización de `post_revision_media` permanece en
el flujo de publicación posterior.
