...
| [0003](0003-protect-admin-with-cloudflare-access.md)                    | Protect admin routes with Cloudflare Access                                     | Accepted (partial) | 2026-07-13 |
...
| [0010](0010-define-public-url-lifecycle-for-localized-posts.md)         | Define public URL lifecycle for localized posts                                 | Accepted (partial) | 2026-08-03 |
...
| [0037](0037-store-structured-highlight-tokens-and-recover-cache-purges.md) | Store structured highlight tokens and recover cache purges | Accepted | 2026-08-13 |
| [0038](0038-keep-retired-post-slugs-append-only.md) | Keep retired post slugs append-only | Accepted | 2026-08-13 |
...
- **Accepted (partial)**: unrelated decisions remain accepted while a newer ADR replaces an explicit subset.
